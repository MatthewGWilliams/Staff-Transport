...
(function($) {
    ...
    $(document).ready(function() {
		...
		//	new google.maps.LatLng(51.315767, -4.184504),
		//	new google.maps.LatLng(51.980400, -2.399226)
		//);
        ...
        $('.geoposition-widget').each(function() {
            var $container = $(this),
                ...
                $searchInput = $('<input>', {'type': 'search', 'placeholder': 'Search address here, then edit house number'}),
                $latitudeField = $container.find('input.geoposition:eq(0)'),
                $longitudeField = $container.find('input.geoposition:eq(1)'),
				$addressField = $container.find('input.geoposition:eq(2)'),
